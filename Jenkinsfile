    ...
    stages {
        stage('Download libs') { 
          steps {
            ...
            sh 'rm -rf /var/jenkins_home/workspace/miroir-standalone-app-ci/packages/miroir-localcache-redux/node_modules'
            sh 'rm -rf /var/jenkins_home/workspace/miroir-standalone-app-ci/packages/miroir-server-msw-stub/node_modules'
            ...
            // sh 'npm link -w miroir-localcache-redux'
