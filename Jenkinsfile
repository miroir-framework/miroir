    ...
    stages {
        stage('Download libs') { 
          steps {
            ...
            sh 'pwd'
            sh 'whoami'
            sh 'cp -r /home/tmp /home/tmp_backup'
            sh 'ls -ail /home/'
            sh 'ls -ail /home/tmp_backup'
            sh 'rm -rf /home/tmp/*'
            sh 'ls -ail /home'
            sh 'cp -r /var/jenkins_home/workspace/miroir-standalone-app-ci /home/tmp'
            sh 'mv /home/tmp_backup/miroir-standalone-app-ci/node_modules /home/tmp/miroir-standalone-app-ci'
            sh 'mv /home/tmp_backup/miroir-standalone-app-ci/miroir-core/node_modules /home/tmp/miroir-standalone-app-ci/miroir-core'
            sh 'mv /home/tmp_backup/miroir-standalone-app-ci/miroir-localcache-redux/node_modules /home/tmp/miroir-standalone-app-ci/miroir-localcache-redux'
            sh 'mv /home/tmp_backup/miroir-standalone-app-ci/miroir-server-msw-stub/node_modules /home/tmp/miroir-standalone-app-ci/miroir-server-msw-stub'
            sh 'mv /home/tmp_backup/miroir-standalone-app-ci/miroir-store-filesystem/node_modules /home/tmp/miroir-standalone-app-ci/miroir-store-filesystem'
            sh 'mv /home/tmp_backup/miroir-standalone-app-ci/miroir-store-indexedDb/node_modules /home/tmp/miroir-standalone-app-ci/miroir-store-indexedDb'
            sh 'mv /home/tmp_backup/miroir-standalone-app-ci/miroir-store-postgres/node_modules /home/tmp/miroir-standalone-app-ci/miroir-store-postgres'
            sh 'mv /home/tmp_backup/miroir-standalone-app-ci/miroir-standalone-app/node_modules /home/tmp/miroir-standalone-app-ci/miroir-standalone-app'
            sh 'ls -ail /home/tmp'
