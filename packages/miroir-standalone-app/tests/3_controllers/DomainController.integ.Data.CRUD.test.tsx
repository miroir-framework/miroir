 ...
 * Canonical leaves: `miroirTest_domain_controller_data_crud` (deployment-miroir; Library is runTarget only).
...
import type { ApplicationDeploymentMap, EndpointDefinition, SelfApplication } from "miroir-core";
import {
