...
import { BuildCompositeAction, BuildPlusRuntimeCompositeAction, BuildPlusRuntimeDomainAction, CompositeRunTestAssertion } from 'miroir-core/src/0_interfaces/1_core/preprocessor-generated/miroirFundamentalType.js';
...
const myConsoleLog = (...args: any[]) => console.log(testSuiteName, ...args);
// const fileName = "DomainNewController.integ.test";
myConsoleLog(testSuiteName, "received env", JSON.stringify(env, null, 2));

let miroirConfig:any;
let loggerOptions:LoggerOptions;
let log:LoggerInterface = console as any as LoggerInterface;
MiroirLoggerFactory.registerLoggerToStart(
  MiroirLoggerFactory.getLoggerName(packageName, cleanLevel, testSuiteName)
          ...
          compositeAction: {
            ...
            templates: {
              ...
              newEntityDetailsReport: {
                ...
                definition: {
                  extractorTemplates: {
                    elementToDisplay: { // TODO: gets interpreted both at build and runtime! Too complex!
...
if (RUN_TEST == testSuiteName) {
  ...
  for (const [currentTestSuiteName, testSuite] of Object.entries(testSuites)) {
