...
const _miroirLoggerName = MiroirLoggerFactory.getLoggerName(packageName, cleanLevel, "EntityInstanceCellRenderer");
...
export const EntityInstanceCellRenderer =  memo((props: ICellRendererParams<TableComponentRow>) => {
  ...
  if (isFK && !props.data?.foreignKeyObjects[entityUuid]) {
    log.warn(
      ...
      "entity", props.colDef?.cellRendererParams.entity,
