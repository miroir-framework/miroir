...
export const EntityInstanceGrid = (props: TableComponentProps & { theme?: DeepPartial<TableTheme> }) => {
  ...
  const onCellClicked = useCallback(
    (event: CellClickedEvent) => {
      ...
      log.info("onCellClicked event.colDef.field", fieldName, "event", event, "props", props);
      ...
      setTimeout(() => {
        if (["name", "uuid"].includes(fieldName)) {
          ...
          if (
            ...
            navigate(
              `/report/${props.application}/${contextDeploymentUuid}/${targetApplicationSection}/${targetEntityDefinition?.defaultInstanceDetailsReportUuid}/${event.data.rawValue[fieldName]}`
            );
          } else {
            log.info(
