...
const valueObjectGridBasePropsSchema = z.object({
  valueObjects: z.array(z.any()), // Array of value objects to display
  mlSchema: jzodObject, // Schema defining the structure/format
...
// Sizing modes (D2-d): same paged / scroll / default variant union as tableComponentCorePropsSchema
export const valueObjectGridPropsSchema = z.union([
  valueObjectGridBasePropsSchema.merge(gridPagedSizingPropsSchema),
  valueObjectGridBasePropsSchema.merge(gridScrollSizingPropsSchema),
  valueObjectGridBasePropsSchema.merge(gridDefaultSizingPropsSchema),
]);
