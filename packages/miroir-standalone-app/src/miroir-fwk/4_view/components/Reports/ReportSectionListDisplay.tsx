...
export const ReportSectionListDisplay: React.FC<ReportComponentProps> = (
  ...
  const instancesToDisplay: EntityInstancesUuidIndex = useMemo(
    () =>
      formikContext.values && reportSectionDefinitionFromFormik?.definition.fetchedDataReference
        ? formikContext.values[reportSectionDefinitionFromFormik.definition.fetchedDataReference]
  ...
  const defaultLabel:string = interpolateExpression(
    reportSectionDefinitionFromFormik?.definition?.label ?? props.label,
    formikContext.values,
    "report label",
  );
        ...
        elements={[
          {
            ...
            data: {
              ...
              fetchedDataReference: reportSectionDefinitionFromFormik?.definition.fetchedDataReference,
            },
            useCodeBlock: true,
          },
          {
