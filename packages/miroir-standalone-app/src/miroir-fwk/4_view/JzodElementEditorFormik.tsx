...
export type JzodElementEditorPropsFormik = JzodElementFormEditorCorePropsFormik
...
export const JzodElementEditorFormik = (
  ...
  if (props.resolvedJzodSchema) {
    switch (props.resolvedJzodSchema.type) {
      ...
      case "array": {
        log.info("############################################### JzodElementEditorFormik array rootLesslistKey", props.rootLesslistKey, "values", props.formik.values);
