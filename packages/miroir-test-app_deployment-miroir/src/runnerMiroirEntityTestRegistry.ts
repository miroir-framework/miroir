...
import runnerMcpGetInstances from "../assets/miroir_data/e54d7dc1-4fbc-495e-9ed9-b5cf081b9fbd/897e9711-65a0-414e-9773-19de92ade533.json" with { type: "json" };
...
export const RUNNER_MIROIR_ENTITY_RUNNER_REGISTRY: Record<string, Runner> = {
  ...
  [runnerMcpGetInstances.uuid]: runnerMcpGetInstances as unknown as Runner,
};
