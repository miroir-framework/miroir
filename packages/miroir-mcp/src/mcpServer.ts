...
import { type McpRequestHandlers } from "./tools/mcpHandlersForEndpoint.js";
...
export class MiroirMcpServer {
  ...
  async setup(): Promise<void> {
    ...
    this.app.get("/sse", async (req, res) => {
      ...
      this.sessions.set(sessionId, { server: this.mcpServer, transport });
...
// ################################################################################################
  ...
  export function setupHandlersForServer(
    ...
    server.setRequestHandler(CallToolRequestSchema, async (request) => {
      ...
      log.info(`callToolRequest Available tools: ${Object.keys(mcpRequestHandlers).join(", ")}`);
