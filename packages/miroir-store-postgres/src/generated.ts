...
export type SqlQueryTableLiteralSchema = string | {
...
export type SqlQueryHereTableDefinitionSchema = string | {
    ...
    queryPart: "hereTable";
    definition: SqlQueryHereTableExpressionSchema;
    as?: string | undefined;
};
...
export const sqlQueryTableLiteralSchema: z.ZodType<SqlQueryTableLiteralSchema> = z.union([z.string(), z.object({queryPart:z.literal("tableLiteral"), name:z.string()}).strict()]);
...
export const sqlQueryHereTableDefinitionSchema: z.ZodType<SqlQueryHereTableDefinitionSchema> = z.union([z.string(), z.object({queryPart:z.literal("bypass"), value:z.string()}).strict(), z.lazy(() =>sqlQueryTableLiteralSchema), z.object({queryPart:z.literal("hereTable"), definition:z.lazy(() =>sqlQueryHereTableExpressionSchema), as:z.string().optional()}).strict()]);
