...
export type EntityUuidIndexedSequelizeModel = {
  [parentUuid in string]: { parentName?: string; idAttribute?: string; isExternal?: boolean; effectiveSchema?: string; sequelizeModel: ModelStatic<Model<any, any>> };
};
