...
describe("rootLessListKeyMap", () => {
  ...
  // mapResolveJzodSchemaToValueKeys path '.definition.section.definition' could not resolve jzod schema for 
  // currentValue [ { "type": "objectListReportSection", "definition": { "parentName": "Author", "parentUuid": "d7a144ff-d1b9-4135-800c-a7cfc1f38733", "label": "Authors", "fetchedDataReference": "authors", "sortByAttribute": "name" } } ]
  //  rawJzodSchema { "type": "tuple", "definition": [ { "type": "object", "definition": { "type": { "type": "literal", "definition": "objectListReportSection" }, "definition": { "type": "object", "definition": { "parentName": { "type": "string", "optional": true, "tag": { "value": { "id": 2, "defaultLabel": "Entity Name", "editable": false } } }, "parentUuid": { "type": "uuid", "tag": { "value": { "id": 2, "defaultLabel": "Entity Uuid", "targetEntity": "16dbfe28-e1d7-4f20-9ba4-c1a9873202ad", "editable": false } } }, "label": { "type": "string", "optional": true, "tag": { "value": { "id": 1, "defaultLabel": "Label", "editable": false } } }, "fetchedDataReference": { "type": "string", "optional": true, "tag": { "value": { "id": 3, "defaultLabel": "Fetched Data Reference", "editable": false } } }, "sortByAttribute": { "type": "string", "optional": true } } } } } ] }
  ...
  //   (jzodTypeCheck as vi.Mock).mockReturnValue(undefined);
