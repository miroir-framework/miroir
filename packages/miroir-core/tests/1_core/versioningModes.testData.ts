/**
 * Shared Version History asset layout constants for versioning-modes tests (not a test file).
 */
import { join } from "node:path";

export const REPO_ROOT = join(import.meta.dirname, "../../../..");

/** Miroir Version History parent folders under assets/miroir_modelVersion/. */
export const MIROIR_VERSION_HISTORY_PARENTS: Readonly<Record<string, number>> = {
  "54b9c72f-d4f3-4db9-9e0e-0dc840b530bd": 35,
