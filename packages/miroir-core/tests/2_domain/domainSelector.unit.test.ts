...
import { EntityDefinition } from "../../src/0_interfaces/1_core/EntityDefinition";
...
import { selectDomainModelMetaInformationFromDomainState, selectFetchedDataFromDomainState } from "../../src/2_domain/DomainSelector";
...
describe("domainSelector", () => {
  ...
  it(
    ...
    () => {
      ...
      const queryParam: DomainFetchQueryParams = {
  ...
  it("getEntityDefinition query: get entity definition from entity Uuid", () => {
    const queryParam: DomainModelQueryParams = {
        type: "getEntityDefinition",
        deploymentUuid: applicationDeploymentLibrary.uuid,
        entityUuid: "e8ba151b-d68e-4cc3-9a83-3459d309ccf5",
    };

    const result: any = selectDomainModelMetaInformationFromDomainState(domainState, queryParam);
