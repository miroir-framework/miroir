...
import { unitTest_suite_queries_library } from "miroir-test-app_deployment-miroir";
import type { UnitTestSuite } from "../../src/0_interfaces/1_core/preprocessor-generated/miroirFundamentalType";

const RUN_TEST = process.env.RUN_TEST;
const testSuiteName = "queries.unit.test";
const shouldSkip = RUN_TEST !== testSuiteName;

const miroirActivityTracker = new MiroirActivityTracker();
const unitTestSuite: UnitTestSuite = unitTest_suite_queries_library.definition as UnitTestSuite;
