...
import {
   transformerTest_miroirCoreTransformers,
...
if (shouldSkip) {
  ...
  await runUnitTransformerTests._runTransformerTestSuite(
    ...
    //         // "plus": [
    //         //   "plus with reference values",
    //         //   "plus with reference values fails",
    //         // ],
    //         // "filterList": [
    //         //   // "filterList keeps elements where predicate is true (boolExpr ==)",
    //         //   "filterList filters objects by attribute value",
    //         //   // "filterList returns empty array when no element matches",
    //         //   // "filterList with context reference for applyTo",
    //         // ],
    //         "find": [
    //           "find returns first element where predicate is true (boolExpr ==)",
    //           "find returns first object where attribute matches",
    //           "find returns null when no element matches",
    //           "find with context reference for applyTo",
    //         ],
    //         // "mergeIntoObject": [
    //         //   // "mergeIntoObject allows to change a returnValue object attribute value",
    //         //   // "mergeIntoObject allows to change a referenced object attribute value",
    //         //   "mergeIntoObject should fail when applyTo fails to resolve correctly",
    //         //   "mergeIntoObject should fail when definition fails to resolve correctly",
    //         // ],
    //         // "createObject": [
    //         //   "createObjectFromPairs allows to dynamically build an object from a returnValue object before runtime (unknown keys, unknown values)",
    //         //   "createObjectFromPairs allows to dynamically build an object before runtime (unknown keys, unknown values)",
    //         //   "createObjectFromPairs allows to dynamically build an object during runtime using getFromParameters (unknown keys, unknown values)",
    //         //   "createObjectFromPairs allows to dynamically build an object using an extractor",
    //         //   "createObject allows to build a simple object with static values",
    //         //   "createObject allows to build a simple object with dynamic values",
    //         //   "createObject allows to build a 2-level object with dynamic values",
    //         //   "createObject should fail when definition fails to resolve correctly ",
    //         //   "createObject should fail when sub-definition fails to resolve correctly",
    //         // ],
    //         // "concatLists": [
