...
export async function startLocalPersistenceStoreControllers(
  ...
  try {
    ...
    console.log('createMiroirDeploymentGetPersistenceStoreControllerDEFUNCT: could not load persisted state from localMiroirPersistenceStoreController, datastore could be empty (this is not a problem)');
  }
  try {
    ...
    console.log('createMiroirDeploymentGetPersistenceStoreControllerDEFUNCT: could not load persisted state from localAppPersistenceStoreController, datastore could be empty (this is not a problem)');
  }
}
