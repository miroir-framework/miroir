...
/**
 * Enhanced LoggerFilter that integrates with ActionLogService to capture logs for specific actions
 */
  ...
  private filter(
    ...
    if (
      ...
      if (this.actionLogService) {
        ...
        this.actionLogService.logForCurrentAction(level, this.name, message, ...args);
      }
    }
  }
