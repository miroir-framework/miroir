import Instance, { EntityInstance } from "../0_interfaces/1_core/Instance";
import { EntityInstancesUuidIndex, EntitiesDomainState } from "../0_interfaces/2_domain/DomainControllerInterface";
