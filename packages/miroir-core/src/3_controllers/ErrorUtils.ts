import { RemoteStoreActionReturnType } from "src/0_interfaces/4-services/remoteStore/RemoteDataStoreInterface";
import { InstanceCollection } from "src/0_interfaces/1_core/Instance";
import { ErrorLogServiceInterface, MError } from "src/0_interfaces/3_controllers/ErrorLogServiceInterface";
// import { RemoteStoreActionReturnType } from "src/0_interfaces/4-services/localStore/LocalStoreInterface";
