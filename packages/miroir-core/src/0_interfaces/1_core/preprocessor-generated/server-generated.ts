...
export type ReportDefinition = GridReportSection | ListReportSection | ObjectList;
export type Report = {
    uuid: string;
    parentName?: string | undefined;
    parentUuid: string;
    ...
    definition?: GridReportSection | ListReportSection | ObjectList;
};
