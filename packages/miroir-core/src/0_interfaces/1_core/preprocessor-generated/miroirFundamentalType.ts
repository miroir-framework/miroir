...
export type PersistenceAction = {
    ...
    uuid?: string | undefined;
    objects?: (EntityInstance | undefined)[] | undefined;
} | RunExtractorAction | RunQueryAction | RunExtractorOrQueryAction | RunQueryTemplateOrExtractorTemplateAction | BundleAction | InstanceAction | ModelAction | StoreManagementAction;
