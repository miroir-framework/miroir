...
export const actionError: z.ZodType<ActionError> = z.object({errorType:z.union([z.literal("FailedToCreateStore"), z.literal("FailedToDeleteStore")]), errorMessage:z.string().optional()}).strict();
