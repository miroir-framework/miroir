...
export const transformerForBuild_objectValues: z.ZodType<TransformerForBuild_objectValues> = z.object({label:z.string().optional()}).strict().merge(z.object({orderBy:z.string().optional()})).strict().merge(z.object({referencedExtractor:z.union([z.string(), z.lazy(() =>transformerForBuild)])})).strict().merge(z.object({transformerType:z.literal("objectValues")})).strict();
...
export const transformerForRuntime_objectValues: z.ZodType<TransformerForRuntime_objectValues> = z.object({interpolation:z.literal("runtime")}).strict().merge(z.object({label:z.string().optional()}).strict().merge(z.object({orderBy:z.string().optional()})).strict().merge(z.object({referencedExtractor:z.union([z.string(), z.lazy(() =>transformerForBuild)])})).strict().merge(z.object({transformerType:z.literal("objectValues")})).strict().merge(z.object({interpolation:z.literal("runtime")}).strict().merge(z.object({orderBy:z.string().optional()})).strict().merge(z.object({referencedExtractor:z.string()})).strict().merge(z.object({})))).strict();
...
export const carryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_transformerForBuild_objectEntries: z.ZodType<CarryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_transformerForBuild_objectEntries> = z.union([z.lazy(() =>carryOnObject), z.object({label:z.string().optional()}).strict().merge(z.object({orderBy:z.string().optional()})).strict().merge(z.object({referencedExtractor:z.union([z.string(), z.lazy(() =>transformerForBuild)])})).strict().merge(z.object({transformerType:z.union([z.literal("objectValues"), z.lazy(() =>carryOnObject)])})).strict()]);
export const carryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_transformerForBuild_objectValues: z.ZodType<CarryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_transformerForBuild_objectValues> = z.union([z.lazy(() =>carryOnObject), z.object({label:z.string().optional()}).strict().merge(z.object({orderBy:z.string().optional()})).strict().merge(z.object({referencedExtractor:z.union([z.string(), z.lazy(() =>transformerForBuild)])})).strict().merge(z.object({transformerType:z.union([z.literal("objectValues"), z.lazy(() =>carryOnObject)])})).strict()]);
