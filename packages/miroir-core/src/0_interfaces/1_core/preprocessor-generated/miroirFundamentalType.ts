...
export const transformerForBuild: z.ZodType<TransformerForBuild> = z.union([z.lazy(() =>transformer_InnerReference), z.lazy(() =>transformerForBuild_dataflowObject), z.lazy(() =>transformerForBuild_freeObjectTemplate), z.lazy(() =>transformerForBuild_inner_object_alter), z.lazy(() =>transformerForBuild_object_fullTemplate), z.lazy(() =>transformerForBuild_objectEntries), z.lazy(() =>transformerForBuild_objectValues), z.lazy(() =>transformerForBuild_object_pickListElement), z.lazy(() =>transformerForBuild_object_listReducerToIndexObject), z.lazy(() =>transformerForBuild_object_listReducerToSpreadObject), z.lazy(() =>transformerForBuild_list_listMapperToList), z.lazy(() =>transformerForBuild_mustacheStringTemplate)]);
...
export const transformerForRuntime_innerFullObjectTemplate: z.ZodType<TransformerForRuntime_innerFullObjectTemplate> = z.object({interpolation:z.literal("runtime")}).strict().merge(z.object({orderBy:z.string().optional()})).strict().merge(z.object({transformerType:z.literal("innerFullObjectTemplate"), referenceToOuterObject:z.string(), definition:z.array(z.object({attributeKey:z.lazy(() =>transformerForRuntime_InnerReference), attributeValue:z.lazy(() =>transformerForRuntime)}).strict())})).strict();
export const transformerForRuntime_object_fullTemplate: z.ZodType<TransformerForRuntime_object_fullTemplate> = z.object({interpolation:z.literal("runtime")}).strict().merge(z.object({orderBy:z.string().optional()})).strict().merge(z.object({referencedExtractor:z.string()})).strict().merge(z.object({transformerType:z.literal("object_fullTemplate"), definition:z.array(z.object({attributeKey:z.lazy(() =>transformerForRuntime_InnerReference), attributeValue:z.lazy(() =>transformerForRuntime)}).strict())})).strict();
