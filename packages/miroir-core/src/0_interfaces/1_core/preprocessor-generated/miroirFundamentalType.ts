...
export type PersistenceAction = {
    ...
    uuid?: string | undefined;
    objects?: (EntityInstance | undefined)[] | undefined;
} | RunBoxedExtractorAction | RunQueryAction | RunBoxedExtractorOrQueryAction | RunBoxedQueryTemplateAction | RunBoxedExtractorTemplateAction | RunBoxedQueryTemplateOrBoxedExtractorTemplateAction | BundleAction | InstanceAction | ModelAction | StoreManagementAction;
