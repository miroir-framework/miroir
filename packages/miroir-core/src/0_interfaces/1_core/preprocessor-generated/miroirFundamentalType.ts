...
export type QuerySelect = QuerySelectExtractorWrapper | {
...
export type RuntimeTransformer = {
    templateType: "count";
...
export type CarryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_objectInstanceReportSection = CarryOnObject | {
    ...
    runtimeTransformers?: (({
        [x: string]: CarryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_runtimeTransformer | CarryOnObject;
    } | undefined) | CarryOnObject) | undefined;
    definition: CarryOnObject | {
        label?: ((string | undefined) | CarryOnObject) | undefined;
        parentUuid: string | CarryOnObject;
...
export type CarryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_runtimeTransformer = {
...
export type CarryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_queryExtractorRuntimeTransformer = CarryOnObject | {
    ...
    actionRuntimeTransformer: CarryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_runtimeTransformer | CarryOnObject;
};
...
export type CarryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_querySelect = (CarryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_querySelectExtractorWrapper | CarryOnObject) | {
...
export const gridReportSection: z.ZodType<GridReportSection> = z.object({type:z.literal("grid"), combiners:z.lazy(() =>miroirSelectQueriesRecord).optional(), runtimeTransformers:z.record(z.string(),z.lazy(() =>runtimeTransformer)).optional(), selectData:z.lazy(() =>miroirSelectQueriesRecord).optional(), definition:z.array(z.array(z.lazy(() =>reportSection)))}).strict();
export const listReportSection: z.ZodType<ListReportSection> = z.object({type:z.literal("list"), combiners:z.lazy(() =>miroirSelectQueriesRecord).optional(), runtimeTransformers:z.record(z.string(),z.lazy(() =>runtimeTransformer)).optional(), selectData:z.lazy(() =>miroirSelectQueriesRecord).optional(), definition:z.array(z.union([z.lazy(() =>objectInstanceReportSection), z.lazy(() =>objectListReportSection)]))}).strict();
...
export const querySelect: z.ZodType<QuerySelect> = z.union([z.lazy(() =>querySelectExtractorWrapper), z.object({queryType:z.literal("wrapperReturningObject"), definition:z.record(z.string(),z.lazy(() =>querySelect))}).strict(), z.object({queryType:z.literal("wrapperReturningList"), definition:z.array(z.lazy(() =>querySelect))}).strict(), z.lazy(() =>extractObjectByDirectReference), z.lazy(() =>querySelectObjectList), z.lazy(() =>querySelectObjectByRelation), z.lazy(() =>querySelectObjectListByRelation), z.lazy(() =>querySelectObjectListByManyToManyRelation), z.lazy(() =>querySelectByQueryCombiner), z.object({queryType:z.literal("literal"), definition:z.string()}).strict(), z.object({queryType:z.literal("queryContextReference"), queryReference:z.string()}).strict()]);
...
export const runtimeTransformer: z.ZodType<RuntimeTransformer> = z.union([z.object({templateType:z.literal("count"), interpolation:z.literal("runtime"), referencedExtractor:z.string(), orderBy:z.string().optional(), groupBy:z.string().optional()}).strict(), z.object({templateType:z.literal("unique"), interpolation:z.literal("runtime"), referencedExtractor:z.string(), orderBy:z.string().optional(), attribute:z.string()}).strict()]);
