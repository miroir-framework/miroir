...
export const test: z.ZodType<Test> = z.object({uuid:z.string(), parentName:z.string().optional(), parentUuid:z.string(), definition:z.union([z.object({testType:z.literal("testCompositeAction"), compositeAction:z.lazy(() =>compositeAction), testCaseAction:z.lazy(() =>runTestCaseCompositeAction)}).strict(), z.object({testType:z.literal("testCase"), definition:z.object({resultAccessPath:z.array(z.string()).optional(), ignoreAttributes:z.array(z.string()).optional(), expectedValue:z.any()}).strict()}).strict()])}).strict();
