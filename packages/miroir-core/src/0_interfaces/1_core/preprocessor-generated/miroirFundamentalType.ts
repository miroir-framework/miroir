...
export type MiroirQuery = ExtractorWrapper | {
    queryType: "wrapperReturningObject";
    definition: {
...
export type CarryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_miroirQuery = CarryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_extractorWrapper | {
...
export const miroirQuery: z.ZodType<MiroirQuery> = z.union([z.lazy(() =>extractorWrapper), z.object({queryType:z.literal("wrapperReturningObject"), definition:z.record(z.string(),z.lazy(() =>miroirQuery))}).strict(), z.object({queryType:z.literal("wrapperReturningList"), definition:z.array(z.lazy(() =>miroirQuery))}).strict(), z.lazy(() =>extractorForObjectByDirectReference), z.lazy(() =>extractorCombinerForObjectByRelation), z.lazy(() =>extractorOrExtractorCombinerReturningObjectList), z.lazy(() =>extractorCombinerByHeteronomousManyToManyReturningListOfObjectList), z.object({queryType:z.literal("literal"), definition:z.string()}).strict(), z.lazy(() =>queryContextReference)]);
