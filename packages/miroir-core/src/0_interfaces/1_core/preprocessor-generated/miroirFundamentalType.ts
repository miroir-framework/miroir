...
export const queryQueriesRecordOrCrossJoin: z.ZodType<QueryQueriesRecordOrCrossJoin> = z.object({parameterSchema:z.lazy(() =>jzodObject).optional(), select:z.lazy(() =>miroirSelectQueriesRecord)}).strict();
