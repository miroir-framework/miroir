...
export type PersistenceAction = {
    ...
    uuid?: string | undefined;
    objects?: (EntityInstance | undefined)[] | undefined;
} | RunBoxedExtractorAction | RunQueryAction | RunBoxedExtractorOrQueryAction | RunQueryTemplateAction | RunBoxedExtractorTemplateAction | RunQueryTemplateOrBoxedExtractorTemplateAction | BundleAction | InstanceAction | ModelAction | StoreManagementAction;
...
export type RunQueryTemplateOrBoxedExtractorTemplateAction = {
...
export type CompositeActionDefinition = ({
    ...
    queryTemplate: RunQueryTemplateAction;
} | {
    ...
    compositeActionStepLabel?: string | undefined;
    nameGivenToResult: string;
    queryTemplate: RunQueryTemplateOrBoxedExtractorTemplateAction;
})[];
...
export type CarryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_domainAction = CarryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_undoRedoAction | CarryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_storeOrBundleAction | CarryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_modelAction | CarryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_instanceAction | {
    ...
    definition: ({
        ...
        compositeActionType: "runQueryTemplateAction" | CarryOnObject;
        compositeActionStepLabel?: ((string | undefined) | CarryOnObject) | undefined;
        nameGivenToResult: string | CarryOnObject;
        queryTemplate: CarryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_runQueryTemplateAction;
    } | {
        ...
        compositeActionType: "runQueryTemplateOrBoxedExtractorTemplateAction" | CarryOnObject;
        compositeActionStepLabel?: ((string | undefined) | CarryOnObject) | undefined;
        nameGivenToResult: string | CarryOnObject;
        queryTemplate: CarryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_runQueryTemplateOrBoxedExtractorTemplateAction;
...
export type CarryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_runQueryTemplateOrBoxedExtractorTemplateAction = CarryOnObject | {
    actionType: "runQueryTemplateOrBoxedExtractorTemplateAction" | CarryOnObject;
    actionName: "runQuery" | CarryOnObject;
    endpoint: "9e404b3c-368c-40cb-be8b-e3c28550c25e" | CarryOnObject;
    applicationSection?: CarryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_applicationSection | undefined;
    deploymentUuid: string | CarryOnObject;
...
export const extractorTemplateForObjectListByEntity: z.ZodType<ExtractorTemplateForObjectListByEntity> = z.object({label:z.string().optional(), applicationSection:z.lazy(() =>applicationSection).optional(), parentName:z.string().optional(), parentUuid:z.lazy(() =>transformer_InnerReference)}).strict().extend({extractorTemplateType:z.literal("extractorTemplateForObjectListByEntity"), filter:z.object({attributeName:z.string(), value:z.lazy(() =>transformer_constantString)}).strict().optional()}).strict();
export const extractorTemplateByRelationReturningObjectList: z.ZodType<ExtractorTemplateByRelationReturningObjectList> = z.object({label:z.string().optional(), applicationSection:z.lazy(() =>applicationSection).optional(), parentName:z.string().optional(), parentUuid:z.lazy(() =>transformer_InnerReference)}).strict().extend({extractorTemplateType:z.literal("combinerByRelationReturningObjectList"), objectReference:z.lazy(() =>transformerForRuntime_InnerReference), objectReferenceAttribute:z.string().optional(), AttributeOfListObjectToCompareToReferenceUuid:z.string()}).strict();
export const extractorTemplateByManyToManyRelationReturningObjectList: z.ZodType<ExtractorTemplateByManyToManyRelationReturningObjectList> = z.object({label:z.string().optional(), applicationSection:z.lazy(() =>applicationSection).optional(), parentName:z.string().optional(), parentUuid:z.lazy(() =>transformer_InnerReference)}).strict().extend({extractorTemplateType:z.literal("combinerByManyToManyRelationReturningObjectList"), objectListReference:z.lazy(() =>transformer_contextReference), objectListReferenceAttribute:z.string().optional(), AttributeOfRootListObjectToCompareToListReferenceUuid:z.string().optional()}).strict();
...
export const carryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_runQueryTemplateOrBoxedExtractorTemplateAction: z.ZodType<CarryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_runQueryTemplateOrBoxedExtractorTemplateAction> = z.union([z.lazy(() =>carryOnObject), z.object({actionType:z.union([z.literal("runQueryTemplateOrBoxedExtractorTemplateAction"), z.lazy(() =>carryOnObject)]), actionName:z.union([z.literal("runQuery"), z.lazy(() =>carryOnObject)]), endpoint:z.union([z.literal("9e404b3c-368c-40cb-be8b-e3c28550c25e"), z.lazy(() =>carryOnObject)]), applicationSection:z.lazy(() =>carryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_applicationSection).optional(), deploymentUuid:z.union([z.string().uuid(), z.lazy(() =>carryOnObject)]), query:z.union([z.lazy(() =>carryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_boxedExtractorTemplateReturningObjectOrObjectList), z.lazy(() =>carryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_queryTemplateWithExtractorCombinerTransformer), z.lazy(() =>carryOnObject)])}).strict()]);
