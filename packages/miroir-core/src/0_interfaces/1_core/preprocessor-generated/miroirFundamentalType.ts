...
export const deploymentAction: z.ZodType<DeploymentAction> = z.object({actionType:z.literal("deploymentAction"), actionName:z.literal("deployApplication"), endpointVersion:z.literal("bbd08cbb-79ff-4539-b91f-7a14f15ac55f"), applicationUuid:z.string().uuid()}).strict();
