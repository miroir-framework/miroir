...
export type QueryTemplateForObjectList = {
    ...
    queryType: "queryTemplateReturningObjectList";
...
export type CarryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_queryTemplateReturningObject = CarryOnObject | {
    ...
    queryType: "queryTemplateReturningObject" | CarryOnObject;
...
export type CarryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_queryTemplateForObjectList = CarryOnObject | {
    ...
    queryType: "queryTemplateReturningObjectList" | CarryOnObject;
...
export const queryEnvelope: z.ZodType<QueryEnvelope> = z.object({deploymentUuid:z.string().uuid(), pageParams:z.record(z.string(),z.any()), queryParams:z.record(z.string(),z.any()), contextResults:z.record(z.string(),z.any())}).strict();
...
export const queryTemplateReturningObject: z.ZodType<QueryTemplateReturningObject> = z.object({deploymentUuid:z.string().uuid(), pageParams:z.record(z.string(),z.any()), queryParams:z.record(z.string(),z.any()), contextResults:z.record(z.string(),z.any())}).strict().extend({queryType:z.literal("queryTemplateReturningObject"), select:z.lazy(() =>extractorTemplateReturningObject)}).strict();
...
export const miroirQueryTemplate: z.ZodType<MiroirQueryTemplate> = z.union([z.lazy(() =>queryTemplateReturningObjectOrObjectList), z.lazy(() =>queryTemplateWithExtractorCombinerTransformer), z.lazy(() =>localCacheExtractor), z.lazy(() =>queryByEntityUuidGetEntityDefinition), z.lazy(() =>queryByTemplateGetParamJzodSchema), z.lazy(() =>queryByQueryTemplateGetParamJzodSchema)]);
export const miroirQuery: z.ZodType<MiroirQuery> = z.union([z.lazy(() =>queryForExtractorOrCombinerReturningObjectOrObjectList), z.lazy(() =>queryWithExtractorCombinerTransformer), z.lazy(() =>localCacheExtractor), z.lazy(() =>queryByEntityUuidGetEntityDefinition), z.lazy(() =>queryByQuery2GetParamJzodSchema), z.lazy(() =>queryByQueryGetParamJzodSchema)]);
...
export const carryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_queryTemplateReturningObject: z.ZodType<CarryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_queryTemplateReturningObject> = z.union([z.lazy(() =>carryOnObject), z.object({deploymentUuid:z.union([z.string().uuid(), z.lazy(() =>carryOnObject)]), pageParams:z.union([z.record(z.string(),z.union([z.any(), z.lazy(() =>carryOnObject)])), z.lazy(() =>carryOnObject)]), queryParams:z.union([z.record(z.string(),z.union([z.any(), z.lazy(() =>carryOnObject)])), z.lazy(() =>carryOnObject)]), contextResults:z.union([z.record(z.string(),z.union([z.any(), z.lazy(() =>carryOnObject)])), z.lazy(() =>carryOnObject)])}).strict().extend({queryType:z.union([z.literal("queryTemplateReturningObject"), z.lazy(() =>carryOnObject)]), select:z.lazy(() =>carryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_extractorTemplateReturningObject)}).strict()]);
export const carryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_queryTemplateForObjectList: z.ZodType<CarryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_queryTemplateForObjectList> = z.union([z.lazy(() =>carryOnObject), z.object({deploymentUuid:z.union([z.string().uuid(), z.lazy(() =>carryOnObject)]), pageParams:z.union([z.record(z.string(),z.union([z.any(), z.lazy(() =>carryOnObject)])), z.lazy(() =>carryOnObject)]), queryParams:z.union([z.record(z.string(),z.union([z.any(), z.lazy(() =>carryOnObject)])), z.lazy(() =>carryOnObject)]), contextResults:z.union([z.record(z.string(),z.union([z.any(), z.lazy(() =>carryOnObject)])), z.lazy(() =>carryOnObject)])}).strict().extend({queryType:z.union([z.literal("queryTemplateReturningObjectList"), z.lazy(() =>carryOnObject)]), select:z.lazy(() =>carryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_extractorTemplateReturningObjectList)}).strict()]);
