...
export type PersistenceAction = {
    ...
    uuid?: string | undefined;
    objects?: (EntityInstance | undefined)[] | undefined;
} | RunExtractorOrQueryAction | RunQueryTemplateOrExtractorTemplateAction | BundleAction | InstanceAction | ModelAction | StoreManagementAction;
