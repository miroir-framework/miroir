...
export type RootReport = {
    ...
    extractorTemplates?: QueryTemplateRecord | undefined;
    extractors?: {
...
export type ExtractorTemplateByExtractorWrapperReturningObject = {
    ...
    definition: {
        [x: string]: QueryContextReference;
    };
};
...
export type CarryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_rootReport = CarryOnObject | {
    ...
    extractorTemplates?: CarryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_queryTemplateRecord | undefined;
    extractors?: (({
...
export type CarryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_extractorTemplateByExtractorWrapperReturningObject = CarryOnObject | {
    ...
    definition: {
        [x: string]: CarryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_queryContextReference;
    } | CarryOnObject;
};
export type CarryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_extractorTemplateByExtractorWrapperReturningList = CarryOnObject | {
    ...
    definition: CarryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_queryContextReference[] | CarryOnObject;
};
...
export const extractorTemplateByExtractorWrapperReturningObject: z.ZodType<ExtractorTemplateByExtractorWrapperReturningObject> = z.object({queryType:z.literal("extractorTemplateByExtractorWrapperReturningObject"), definition:z.record(z.string(),z.lazy(() =>queryContextReference))}).strict();
export const extractorTemplateByExtractorWrapperReturningList: z.ZodType<ExtractorTemplateByExtractorWrapperReturningList> = z.object({queryType:z.literal("extractorTemplateByExtractorWrapperReturningList"), definition:z.array(z.lazy(() =>queryContextReference))}).strict();
...
export const queryTemplate: z.ZodType<QueryTemplate> = z.union([z.lazy(() =>extractorTemplateByExtractorWrapper), z.lazy(() =>extractorTemplateExtractorForObjectByDirectReference), z.lazy(() =>extractorTemplateReturningObjectList), z.lazy(() =>extractorTemplateCombinerForObjectByRelation), z.lazy(() =>extractorTemplateByRelationReturningObjectList), z.lazy(() =>extractorTemplateByManyToManyRelationReturningObjectList), z.lazy(() =>extractorTemplateByExtractorCombiner), z.object({queryType:z.literal("literal"), definition:z.string()}).strict()]);
...
export const extractorTemplateForSingleObject: z.ZodType<ExtractorTemplateForSingleObject> = z.object({deploymentUuid:z.string().uuid(), pageParams:z.record(z.string(),z.any()), queryParams:z.record(z.string(),z.any()), contextResults:z.record(z.string(),z.any())}).strict().extend({queryType:z.literal("extractorTemplateForDomainModelObjects"), select:z.lazy(() =>extractorTemplateReturningObject)}).strict();
export const extractorTemplateForSingleObjectList: z.ZodType<ExtractorTemplateForSingleObjectList> = z.object({deploymentUuid:z.string().uuid(), pageParams:z.record(z.string(),z.any()), queryParams:z.record(z.string(),z.any()), contextResults:z.record(z.string(),z.any())}).strict().extend({queryType:z.literal("extractorTemplateForDomainModelObjects"), select:z.lazy(() =>extractorTemplateReturningObjectList)}).strict();
...
export const queryTemplateWithExtractorCombinerTransformer: z.ZodType<QueryTemplateWithExtractorCombinerTransformer> = z.object({deploymentUuid:z.string().uuid(), pageParams:z.record(z.string(),z.any()), queryParams:z.record(z.string(),z.any()), contextResults:z.record(z.string(),z.any())}).strict().extend({queryType:z.literal("queryTemplateWithExtractorCombinerTransformer"), runAsSql:z.boolean().optional(), extractorTemplates:z.lazy(() =>queryTemplateRecord).optional(), combinerTemplates:z.lazy(() =>queryTemplateRecord).optional(), runtimeTransformers:z.record(z.string(),z.lazy(() =>extendedTransformerForRuntime)).optional()}).strict();
