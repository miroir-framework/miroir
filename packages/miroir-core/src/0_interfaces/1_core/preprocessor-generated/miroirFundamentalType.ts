...
export type ModelAction = {
    ...
    entityName?: string | undefined;
    entityUuid: string;
    entityAttributeName?: string | undefined;
    targetValue?: any;
} | {
    actionType: "modelAction";
    actionName: "renameEntity";
