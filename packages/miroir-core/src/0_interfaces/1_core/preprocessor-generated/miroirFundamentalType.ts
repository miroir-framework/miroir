...
export type LocalCacheAction = UndoRedoAction | ModelAction | InstanceAction | {
...
export type StoreOrBundleAction = StoreAction | BundleAction;
...
export const localCacheAction: z.ZodType<LocalCacheAction> = z.union([z.lazy(() =>undoRedoAction), z.lazy(() =>modelAction), z.lazy(() =>instanceAction), z.object({actionType:z.literal("localCacheTransactionalInstanceActionWithDeployment"), deploymentUuid:z.string().uuid(), instanceAction:z.lazy(() =>instanceCUDAction)}).strict()]);
export const transactionalInstanceAction: z.ZodType<TransactionalInstanceAction> = z.object({actionType:z.literal("transactionalInstanceAction"), instanceAction:z.lazy(() =>instanceCUDAction)}).strict();
export const domainAction: z.ZodType<DomainAction> = z.union([z.lazy(() =>undoRedoAction), z.lazy(() =>modelAction), z.lazy(() =>instanceAction), z.object({actionType:z.literal("transactionalInstanceAction"), instanceAction:z.lazy(() =>instanceCUDAction)}).strict()]);
...
export const storeOrBundleAction: z.ZodType<StoreOrBundleAction> = z.union([z.lazy(() =>storeAction), z.lazy(() =>bundleAction)]);
