...
export const transformerForBuild_count: z.ZodType<TransformerForBuild_count> = z.object({interpolation:z.literal("build"), applyTo:z.union([z.object({referenceType:z.literal("referencedExtractor"), reference:z.union([z.string(), z.lazy(() =>transformer_extractors)])}).strict(), z.object({referenceType:z.literal("referencedTransformer"), reference:z.union([z.string(), z.lazy(() =>transformerForBuild)])}).strict()]), transformerType:z.literal("count"), attribute:z.string().optional(), groupBy:z.string().optional()}).strict();
...
export const transformerForRuntime_count: z.ZodType<TransformerForRuntime_count> = z.object({interpolation:z.literal("runtime"), applyTo:z.union([z.object({referenceType:z.literal("referencedExtractor"), reference:z.union([z.string(), z.lazy(() =>transformer_extractors)])}).strict(), z.object({referenceType:z.literal("referencedTransformer"), reference:z.union([z.string(), z.lazy(() =>transformerForRuntime)])}).strict()]), transformerType:z.literal("count"), attribute:z.string().optional(), groupBy:z.string().optional()}).strict();
