...
export const testAssertion: z.ZodType<TestAssertion> = z.object({testType:z.literal("testAssertion"), definition:z.object({resultAccessPath:z.array(z.string()).optional(), ignoreAttributes:z.array(z.string()).optional(), expectedValue:z.any()}).strict()}).strict();
...
export const carryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_testAssertion: z.ZodType<CarryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_testAssertion> = z.union([z.lazy(() =>carryOnObject), z.object({testType:z.union([z.literal("testAssertion"), z.lazy(() =>carryOnObject)]), definition:z.union([z.lazy(() =>carryOnObject), z.object({resultAccessPath:z.union([z.array(z.union([z.string(), z.lazy(() =>carryOnObject)])).optional(), z.lazy(() =>carryOnObject)]).optional(), ignoreAttributes:z.union([z.array(z.union([z.string(), z.lazy(() =>carryOnObject)])).optional(), z.lazy(() =>carryOnObject)]).optional(), expectedValue:z.union([z.any(), z.lazy(() =>carryOnObject)])}).strict()])}).strict()]);
