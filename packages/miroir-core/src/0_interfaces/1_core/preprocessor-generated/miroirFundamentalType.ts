...
export type ExtractorOrCombiner = ExtractorWrapper | QueryContextReference | {
    queryType: "combiner_wrapperReturningObject";
    definition: {
...
} | ExtractorForObjectByDirectReference | ExtractorCombinerForObjectByRelation | ExtractorOrCombinerReturningObjectList | ExtractorCombinerByHeteronomousManyToManyReturningListOfObjectList | {
    queryType: "literal";
    definition: string;
};
...
export type CarryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_queryForExtractorOrCombinerReturningObjectList = CarryOnObject | {
    ...
    queryType: "queryForExtractorOrCombinerReturningObjectOrObjectList" | CarryOnObject;
...
export type CarryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_extractorOrCombiner = CarryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_extractorWrapper | CarryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_queryContextReference | {
...
export const extractorOrCombiner: z.ZodType<ExtractorOrCombiner> = z.union([z.lazy(() =>extractorWrapper), z.lazy(() =>queryContextReference), z.object({queryType:z.literal("combiner_wrapperReturningObject"), definition:z.record(z.string(),z.lazy(() =>extractorOrCombiner))}).strict(), z.object({queryType:z.literal("combiner_wrapperReturningList"), definition:z.array(z.lazy(() =>extractorOrCombiner))}).strict(), z.lazy(() =>extractorForObjectByDirectReference), z.lazy(() =>extractorCombinerForObjectByRelation), z.lazy(() =>extractorOrCombinerReturningObjectList), z.lazy(() =>extractorCombinerByHeteronomousManyToManyReturningListOfObjectList), z.object({queryType:z.literal("literal"), definition:z.string()}).strict()]);
...
export const queryForExtractorOrCombinerReturningObjectList: z.ZodType<QueryForExtractorOrCombinerReturningObjectList> = z.object({deploymentUuid:z.string().uuid(), pageParams:z.record(z.string(),z.any()), queryParams:z.record(z.string(),z.any()), contextResults:z.record(z.string(),z.any())}).strict().extend({queryType:z.literal("queryForExtractorOrCombinerReturningObjectOrObjectList"), select:z.lazy(() =>extractorOrCombinerReturningObjectList)}).strict();
...
export const carryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_queryForExtractorOrCombinerReturningObjectList: z.ZodType<CarryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_queryForExtractorOrCombinerReturningObjectList> = z.union([z.lazy(() =>carryOnObject), z.object({deploymentUuid:z.union([z.string().uuid(), z.lazy(() =>carryOnObject)]), pageParams:z.union([z.record(z.string(),z.union([z.any(), z.lazy(() =>carryOnObject)])), z.lazy(() =>carryOnObject)]), queryParams:z.union([z.record(z.string(),z.union([z.any(), z.lazy(() =>carryOnObject)])), z.lazy(() =>carryOnObject)]), contextResults:z.union([z.record(z.string(),z.union([z.any(), z.lazy(() =>carryOnObject)])), z.lazy(() =>carryOnObject)])}).strict().extend({queryType:z.union([z.literal("queryForExtractorOrCombinerReturningObjectOrObjectList"), z.lazy(() =>carryOnObject)]), select:z.lazy(() =>carryOn_fe9b7d99$f216$44de$bb6e$60e1a1ebb739_extractorOrCombinerReturningObjectList)}).strict()]);
