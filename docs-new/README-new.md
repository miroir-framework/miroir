...
## Example: Building a Book Library App

### Define Your Model (Jzod Schema)
...
```json
{
  ...
  "definition": {
    ...
    "title": { "type": "string" },
    "author": { "type": "string", "tag": { "value": { "id": 1, "defaultLabel": "Author", "targetEntity": "Author" } } },
...
### Query Your Data (Declarative)

```json
{
  "queryType": "extractorForRecordOfExtractors",
  "extractors": {
    "books": { "queryType": "queryExtractObjectListByEntity", "parentUuid": "Book" },
    "authors": { "queryType": "queryExtractObjectListByEntity", "parentUuid": "Author" }
  }
}
```
