...
Generated: 2026-06-08T13:34:46.480Z
...
|------|-------|--------------|---------------|
| functionCallTest | 30 | 282 | 0 |
| transformerTest | 10 | 25 | 8 |
| queryRunnerTest | 1 | 18 | 0 |
| compositeActionTest | 1 | 2 | 0 |
...
| `1_core/jzod/jzodToJsonSchema.unit.test.ts` | B | functionCallTest | 18 | no |  |
...
| `1_core/mustache.unit.test.ts` | B | functionCallTest | 6 | no |  |
...
| `2_domain/queries.unit.test.ts` | C | queryRunnerTest | 18 | no | testExtractorParams table-driven; domainState.json fixture |
| `2_domain/resolveCompositeActionTemplate.unit.test.ts` | D | compositeActionTest | 2 | no |  |
