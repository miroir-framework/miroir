...
**Status:** implemented (slices 1–4 DONE). Decisions confirmed with the user (2026-09-21 grilling). Revised after adversarial review ([`./adversarial-review.md`](./adversarial-review.md), R1–R14 applied). Implementation plan: [`./tdd-implementation-plan.md`](./tdd-implementation-plan.md) (revised after [`./plan-adversarial-review.md`](./plan-adversarial-review.md), P1–P21).
...
| Typed report section from operation `responseSchema`; Entity optional | **#281 (this document)** | ✅ implemented (slices 1–4) |
