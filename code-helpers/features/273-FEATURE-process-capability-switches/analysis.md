...
**Status:** implemented (slices 1 to 9 done 2026-09-13). Decisions confirmed with the user (2026-09-12). Revised after adversarial review ([`./adversarial-review.md`](./adversarial-review.md), R1–R12 applied). Product choices D1–D15 unchanged.
...
| Process capability snapshot + hide/refuse | **#273 (this)** | ✅ implemented |
